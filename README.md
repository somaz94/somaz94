...
### Kubernetes CRD
[![k8s-namespace-sync](https://img.shields.io/badge/k8s--namespace--sync-blue?logo=kubernetes&logoColor=white)](https://github.com/somaz94/k8s-namespace-sync)[![helios-lb](https://img.shields.io/badge/helios--lb-blue?logo=kubernetes&logoColor=white)](https://github.com/somaz94/helios-lb)[![network-policy-generator](https://img.shields.io/badge/network--policy--generator-blue?logo=kubernetes&logoColor=white)](https://github.com/somaz94/network-policy-generator)

### GitHub Actions

#### Helm & K8s Actions
[![kube-diff-action](https://img.shields.io/badge/kube--diff--action-blue?logo=githubactions&logoColor=white)](https://github.com/somaz94/kube-diff-action)[![kube-events-action](https://img.shields.io/badge/kube--events--action-blue?logo=githubactions&logoColor=white)](https://github.com/somaz94/kube-events-action)[![helm-oci-push-action](https://img.shields.io/badge/helm--oci--push--action-blue?logo=githubactions&logoColor=white)](https://github.com/somaz94/helm-oci-push-action)[![helm-chart-release-action](https://img.shields.io/badge/helm--chart--release--action-blue?logo=githubactions&logoColor=white)](https://github.com/somaz94/helm-chart-release-action)[![helm-kustomize-lint-action](https://img.shields.io/badge/helm--kustomize--lint--action-blue?logo=githubactions&logoColor=white)](https://github.com/somaz94/helm-kustomize-lint-action)[![kind-e2e-test-action](https://img.shields.io/badge/kind--e2e--test--action-blue?logo=githubactions&logoColor=white)](https://github.com/somaz94/kind-e2e-test-action)[![go-kubebuilder-test-action](https://img.shields.io/badge/go--kubebuilder--test--action-blue?logo=githubactions&logoColor=white)](https://github.com/somaz94/go-kubebuilder-test-action)

#### Go / Docker Action CI
[![go-git-commit-action](https://img.shields.io/badge/go--git--commit--action-blue?logo=githubactions&logoColor=white)](https://github.com/somaz94/go-git-commit-action)[![go-changelog-action](https://img.shields.io/badge/go--changelog--action-blue?logo=githubactions&logoColor=white)](https://github.com/somaz94/go-changelog-action)[![contributors-action](https://img.shields.io/badge/contributors--action-blue?logo=githubactions&logoColor=white)](https://github.com/somaz94/contributors-action)[![major-tag-action](https://img.shields.io/badge/major--tag--action-blue?logo=githubactions&logoColor=white)](https://github.com/somaz94/major-tag-action)[![env-output-setter](https://img.shields.io/badge/env--output--setter-blue?logo=githubactions&logoColor=white)](https://github.com/somaz94/env-output-setter)[![go-docker-action-ci-action](https://img.shields.io/badge/go--docker--action--ci--action-blue?logo=githubactions&logoColor=white)](https://github.com/somaz94/go-docker-action-ci-action)

#### Ansible Actions
[![ansible-molecule-test-action](https://img.shields.io/badge/ansible--molecule--test--action-blue?logo=githubactions&logoColor=white)](https://github.com/somaz94/ansible-molecule-test-action)[![ansible-galaxy-publish-action](https://img.shields.io/badge/ansible--galaxy--publish--action-blue?logo=githubactions&logoColor=white)](https://github.com/somaz94/ansible-galaxy-publish-action)

#### Utilities
[![ternary-operator](https://img.shields.io/badge/ternary--operator-blue?logo=githubactions&logoColor=white)](https://github.com/somaz94/ternary-operator)[![commit-info-extractor](https://img.shields.io/badge/commit--info--extractor-blue?logo=githubactions&logoColor=white)](https://github.com/somaz94/commit-info-extractor)[![image-tag-updater](https://img.shields.io/badge/image--tag--updater-blue?logo=githubactions&logoColor=white)](https://github.com/somaz94/image-tag-updater)[![compress-decompress](https://img.shields.io/badge/compress--decompress-blue?logo=githubactions&logoColor=white)](https://github.com/somaz94/compress-decompress)[![multi-git-mirror](https://img.shields.io/badge/multi--git--mirror-blue?logo=githubactions&logoColor=white)](https://github.com/somaz94/multi-git-mirror)

### Helm Charts
[![helm-charts](https://img.shields.io/badge/helm--charts-blue?logo=helm&logoColor=white)](https://github.com/somaz94/helm-charts)

### DevOps Tools
[![bash-pilot](https://img.shields.io/badge/bash--pilot-blue?logo=gnu-bash&logoColor=white)](https://github.com/somaz94/bash-pilot)[![git-bridge](https://img.shields.io/badge/git--bridge-blue?logo=git&logoColor=white)](https://github.com/somaz94/git-bridge)[![kube-diff](https://img.shields.io/badge/kube--diff-blue?logo=kubernetes&logoColor=white)](https://github.com/somaz94/kube-diff)[![kube-events](https://img.shields.io/badge/kube--events-blue?logo=kubernetes&logoColor=white)](https://github.com/somaz94/kube-events)[![slack-qr-bot](https://img.shields.io/badge/slack--qr--bot-blue?logo=slack&logoColor=white)](https://github.com/somaz94/slack-qr-bot)[![static-file-server](https://img.shields.io/badge/static--file--server-blue?logo=go&logoColor=white)](https://github.com/somaz94/static-file-server)
